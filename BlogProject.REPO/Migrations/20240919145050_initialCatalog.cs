    ...
    public partial class initialCatalog : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "a02760c9-e021-4def-80a6-e07006e2bc37", "Admin", "ADMIN" },
                    { "2", "357cd6e5-fbc5-41fa-a16a-e3fde69e888a", "Editor", "EDITOR" },
                    { "3", "9ced3b5c-d196-4c81-ba43-03ce85b07026", "Verifieduser", "VERIFIEDUSER" },
                    { "4", "15d8d94b-eaf4-4cb3-a5b2-11b9cfa0a16d", "Newuser", "NEWUSER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", 0, "ea548a91-a5d8-4397-bcf5-1592e58d6f8d", "admin@mail.com", true, false, null, "ADMIN@MAIL.COM", "ADMIN", "AQAAAAEAACcQAAAAECfv8FjY2hE+hkr3CFvND8DxcG6X9H8q67GqlyNC9+GrOLEG6HohDzfMb7Mc8QdOZA==", "1234567890", true, "Admin.jpg", "947607a1-b5b6-4142-8d2c-c91982205cae", false, "Admin" },
                    { "10", 0, "be3f7d0a-0361-4584-83c9-b77c7c63e156", "verifieduser6@mail.com", true, false, null, "VERIFIEDUSER6@MAIL.COM", "VERIFIEDUSER6", "AQAAAAEAACcQAAAAEG5EglKGkiqrEATTj4mJmgCqDcaMGDtE6iFR2u+enB4jlkTZE0mO/R3ixMEg2S0DwA==", "1234567890", true, "UserImage6.jpg", "fe587447-1dc7-4526-a5c9-3b35c41e5e85", false, "Verifieduser6" },
                    { "11", 0, "b0ecaf1d-93d0-470d-931c-78853cf0338a", "verifieduser7@mail.com", true, false, null, "VERIFIEDUSER7@MAIL.COM", "VERIFIEDUSER7", "AQAAAAEAACcQAAAAEMQUlGc1ZUwhP6+iqqZ/CbpmIrFyoNkSLZJysltHYv1YhMe1ikQJHvp4VhM+erxuIQ==", "1234567890", true, "UserImage7.jpg", "c6a1fcab-96b9-411e-8fc7-05dfaec6ecdd", false, "Verifieduser7" },
                    { "12", 0, "e76490e6-d1ba-49f8-8304-2ba2106a45d5", "verifieduser8@mail.com", true, false, null, "VERIFIEDUSER8@MAIL.COM", "VERIFIEDUSER8", "AQAAAAEAACcQAAAAEA37m1nAE3wnzj6wOE0bWJJU4qJIThBgCB48NYF1HOe625FxXZyc6mei2g83G+T67w==", "1234567890", true, "UserImage8.jpg", "32355345-546f-49e1-8835-dc8ba2a376a2", false, "Verifieduser8" },
                    { "2", 0, "196bff59-220d-4b1e-a465-4bfeaa21d2a5", "editor@mail.com", true, false, null, "EDITOR@MAIL.COM", "EDITOR", "AQAAAAEAACcQAAAAENpjsmQcmmhPQsShHDxkOMs/gUJdD2czi8ra5LIiTYn7b9Bqa71XmJxxq+LMO9wR7Q==", "1234567890", true, "Admin.jpg", "cda4569e-1663-4df8-8496-d22d24547d35", false, "Editor" },
                    { "3", 0, "922c530a-fd44-4150-8950-f2848abf2263", "verifieduser1@mail.com", true, false, null, "VERIFIEDUSER1@MAIL.COM", "VERIFIEDUSER1", "AQAAAAEAACcQAAAAEOGbKLw7kO8cJuDc8bCrYMqFGTdK3ZzSWRH3ppdI2A1QTnrIlLny+5+8+b5syW+IsQ==", "1234567890", true, "UserImage1.jpg", "de692562-cbdb-4712-99fc-4d56eeeda585", false, "Verifieduser1" },
                    { "4", 0, "4819c160-9887-4274-934d-a6be5af0e98b", "newuse1r@mail.com", false, false, null, "NEWUSER1@MAIL.COM", "NEWUSER1", "AQAAAAEAACcQAAAAEAlh64eG+qvSQFgrJBbt4wkIeIq+UhJtTKH5aDMsY4bTR6PZjt6GNL8aUxlfzFfblQ==", "1234567890", false, "DefaultUser.jpg", "e29e5107-9963-447b-b37c-61b2c942632d", false, "Newuser1" },
                    { "5", 0, "32481c0c-4640-4aed-999d-5c67df2ef4b2", "newuser2@mail.com", false, false, null, "NEWUSER2@MAIL.COM", "NEWUSER2", "AQAAAAEAACcQAAAAEOnuCvTuUQ0s/R0467lBdjSQAKdosk2XNzlfdQ8wWO3N4DjEHnxNlOVxdu41OJSYfQ==", "1234567890", false, "DefaultUser.jpg", "30d6b77e-ddc0-4b33-999a-7a69d199b307", false, "Newuser2" },
                    { "6", 0, "684f4f9f-7a9e-4551-abc5-f0840501a59e", "verifieduser2@mail.com", true, false, null, "VERIFIEDUSER2@MAIL.COM", "VERIFIEDUSER2", "AQAAAAEAACcQAAAAEOl8RbKmIVxk1w3Yo2WM/QRVTQPXClwSFpw4UzBg8DtZQ5omVb75D7LlpWBE/eVrwg==", "1234567890", true, "UserImage2.jpg", "ae3446fb-e41d-4e20-9d89-b65d72573366", false, "Verifieduser2" },
                    { "7", 0, "75d5cc13-0a7e-4821-8fba-23802394d545", "verifieduser3@mail.com", true, false, null, "VERIFIEDUSER3@MAIL.COM", "VERIFIEDUSER3", "AQAAAAEAACcQAAAAEGl79aBNRv1ET8tfV/O7F0+xn5lx5bLg37Vg9DtEG8xEnvF4S9MXL+Sx+MmEOqfPyA==", "1234567890", true, "UserImage3.jpg", "30d3cf8d-fb1f-4886-9f37-8c9782dbeef8", false, "Verifieduser3" },
                    { "8", 0, "cc6dd80f-71cc-4709-8a49-518841795f29", "verifieduser4@mail.com", true, false, null, "VERIFIEDUSER4@MAIL.COM", "VERIFIEDUSER4", "AQAAAAEAACcQAAAAEGlPxsefivn+Gx0mlmvezIlBKlfzX3/QpO6dN/M3DlcgWXC5LckSNMTeeaotEu6wPg==", "1234567890", true, "UserImage4.jpg", "08b5841a-2621-48be-ae6d-6b93d82b0fa2", false, "Verifieduser4" },
                    { "9", 0, "803bce24-2239-46ed-98f3-d71790d52869", "verifieduser5@mail.com", true, false, null, "VERIFIEDUSER5@MAIL.COM", "VERIFIEDUSER5", "AQAAAAEAACcQAAAAEL1GZvqWNjc3jUsf/uiVg59cfkR8dPvU+RAtze49TVR4tdC6h8cPTjDWGiZChGQi1A==", "1234567890", true, "UserImage5.jpg", "0d2811ef-0cc1-43b7-bb3f-4c47d5384bb9", false, "Verifieduser5" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 19, 17, 50, 49, 922, DateTimeKind.Local).AddTicks(4520), null, "Yazılım geliştirme ve programlama dilleri üzerine içerikler.", "Yazılım", 0, null },
                    { "10", new DateTime(2024, 9, 19, 17, 50, 49, 922, DateTimeKind.Local).AddTicks(4542), null, "Veri analitiği, veri işleme ve büyük veri teknolojileri hakkında içerikler.", "Veri Bilimi", 0, null },
                    { "11", new DateTime(2024, 9, 19, 17, 50, 49, 922, DateTimeKind.Local).AddTicks(4545), null, "Yapay zeka, robotik süreç otomasyonu ve robot teknolojileri üzerine bilgiler.", "Yapay Zeka ve Robotik", 0, null },
                    { "12", new DateTime(2024, 9, 19, 17, 50, 49, 922, DateTimeKind.Local).AddTicks(4547), null, "Bilgisayar donanımı, sistem bileşenleri ve teknik detaylar hakkında bilgiler.", "Donanım", 0, null },
                    { "13", new DateTime(2024, 9, 19, 17, 50, 49, 922, DateTimeKind.Local).AddTicks(4549), null, "Kullanıcı deneyimi (UX) ve insan-bilgisayar etkileşimi üzerine bilgiler.", "İnsan Bilgisayar Etkileşimi", 0, null },
                    { "14", new DateTime(2024, 9, 19, 17, 50, 49, 922, DateTimeKind.Local).AddTicks(4552), null, "Siber tehditler ve güvenlik açıkları hakkında içerikler.", "Siber Tehditler", 0, null },
                    { "15", new DateTime(2024, 9, 19, 17, 50, 49, 922, DateTimeKind.Local).AddTicks(4554), null, "Yazılım geliştirme süreçleri, yazılım mühendisliği prensipleri üzerine bilgiler.", "Yazılım Mühendisliği", 0, null },
                    { "2", new DateTime(2024, 9, 19, 17, 50, 49, 922, DateTimeKind.Local).AddTicks(4523), null, "Sistem yönetimi ve ağ altyapıları üzerine bilgiler.", "Sistem", 0, null },
                    { "3", new DateTime(2024, 9, 19, 17, 50, 49, 922, DateTimeKind.Local).AddTicks(4525), null, "Web tasarımı ve grafik tasarım trendleri hakkında içerikler.", "Web Grafik", 0, null },
                    { "4", new DateTime(2024, 9, 19, 17, 50, 49, 922, DateTimeKind.Local).AddTicks(4527), null, "Siber güvenlik, veri koruma ve sistem güvenliği üzerine bilgiler.", "Güvenlik", 0, null },
                    { "5", new DateTime(2024, 9, 19, 17, 50, 49, 922, DateTimeKind.Local).AddTicks(4529), null, "Bulut bilişim ve bulut teknolojileri üzerine bilgiler.", "Bulut Sistemler", 0, null },
                    { "6", new DateTime(2024, 9, 19, 17, 50, 49, 922, DateTimeKind.Local).AddTicks(4531), null, "Veritabanı yönetim sistemleri ve veri işleme teknikleri üzerine içerikler.", "Veritabanı", 0, null },
                    { "7", new DateTime(2024, 9, 19, 17, 50, 49, 922, DateTimeKind.Local).AddTicks(4533), null, "Yapay zeka, makine öğrenimi ve derin öğrenme hakkında içerikler.", "Yapay Zeka", 0, null },
                    { "8", new DateTime(2024, 9, 19, 17, 50, 49, 922, DateTimeKind.Local).AddTicks(4536), null, "Mobil uygulama geliştirme, Android ve iOS platformları üzerine bilgiler.", "Mobil Uygulama", 0, null },
                    { "9", new DateTime(2024, 9, 19, 17, 50, 49, 922, DateTimeKind.Local).AddTicks(4540), null, "Oyun motorları, oyun geliştirme teknikleri ve oyun tasarımı üzerine içerikler.", "Oyun Geliştirme", 0, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "7", false, "1", "C# dilinin OOP özelliklerini bu kadar net ve anlaşılır bir şekilde açıklamanız gerçekten çok faydalı oldu. Özellikle polimorfizm ve soyutlama kavramlarını bu kadar detaylı anlamak, projelerimde daha modüler yapılar kurmama yardımcı olacak.", new DateTime(2024, 9, 19, 17, 50, 49, 922, DateTimeKind.Local).AddTicks(6409), null, 0, null },
                    { "2", "8", false, "1", "Makaledeki encapsulation (kapsülleme) ve inheritance (kalıtım) kavramları üzerine verdiğiniz örnekler çok açıklayıcıydı. C# dilinde daha önce bu kavramları yüzeysel biliyordum ama şimdi projelerimde daha etkin kullanabileceğimi düşünüyorum. Teşekkürler!", new DateTime(2024, 9, 19, 17, 50, 49, 922, DateTimeKind.Local).AddTicks(6416), null, 0, null },
                    { "3", "11", false, "5", "Hyper-V ile sanallaştırmanın nasıl donanım maliyetlerini düşürdüğünü çok güzel açıklamışsınız. Bu teknolojiyi kullanarak test ortamları oluşturmanın ne kadar kolay olduğunu öğrendim. Geliştirme ve test süreçlerimde kesinlikle kullanacağım.", new DateTime(2024, 9, 19, 17, 50, 49, 922, DateTimeKind.Local).AddTicks(6419), null, 0, null },
                    { "4", "6", false, "5", "Felaket kurtarma planları oluştururken Hyper-V'nin ne kadar esnek ve etkili olduğunu vurgulamanız çok iyi olmuş. Sanal makinelerle çalışmak, IT yönetimi için büyük bir avantaj. Makale sayesinde bu teknolojiyi daha iyi anladım ve sistemlerimde kullanmayı düşünüyorum.", new DateTime(2024, 9, 19, 17, 50, 49, 922, DateTimeKind.Local).AddTicks(6422), null, 0, null },
                    { "5", "10", false, "18", "Yedekleme stratejilerinin detaylı bir şekilde ele alınması çok faydalı oldu. Özellikle artımlı ve diferansiyel yedekleme arasındaki farkı öğrenmek benim için önemliydi. Şirketimizde veritabanı yönetimi yaparken bu bilgileri uygulayacağım.", new DateTime(2024, 9, 19, 17, 50, 49, 922, DateTimeKind.Local).AddTicks(6425), null, 0, null },
                    { "6", "11", false, "18", "Yedekleme stratejilerinin sadece planlanmasının yeterli olmadığını, aynı zamanda kurtarma senaryolarının da düzenli olarak test edilmesi gerektiğini vurgulamanız çok önemli. Veri güvenliği için bu makalede önerilen yöntemleri uygulamaya başlayacağım.", new DateTime(2024, 9, 19, 17, 50, 49, 922, DateTimeKind.Local).AddTicks(6428), null, 0, null }
                });
